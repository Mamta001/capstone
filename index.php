...
<div id="menu1" class="tab-pane fade">
    <div class="languages">
    	<div class="row"> 
        	<a href="http://localhost/DreamTeam_Capstone/capstone.github.io/tutec.php" style="font-size:24px;margin-left:30px">
            <span class="glyphicon glyphicon-tree-deciduous">
            <br/> C
            </span>
            </a>
            <a href="http://localhost/DreamTeam_Capstone/capstone.github.io/tutecss.php">
